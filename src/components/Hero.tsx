      ...
      <div className="container mx-auto px-4 text-center relative z-10">
        <div className="max-w-5xl mx-auto space-y-8 animate-fade-in">
          <div className="inline-block mb-4">
            <div className="px-6 py-2 bg-white/10 backdrop-blur-sm rounded-full border-2 border-white/30">
              <p className="text-sm font-semibold tracking-wider uppercase">Made in Italy • Качество с 1990 года</p>
            </div>
          </div>
