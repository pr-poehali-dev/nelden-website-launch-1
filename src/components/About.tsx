        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center max-w-7xl mx-auto">
          <div className="order-2 lg:order-1">
            ...
            <div className="grid sm:grid-cols-2 gap-6">
              {features.map((feature, index) => (
                <div 
                  key={index} 
                  className="group p-6 rounded-xl bg-gradient-to-br from-card to-background border-2 border-transparent hover:border-accent/30 transition-all duration-300 hover:shadow-lg hover:-translate-y-1"
                >
                  <div className="flex items-start space-x-4">
                    <div className="w-14 h-14 rounded-xl bg-accent/10 flex items-center justify-center flex-shrink-0 group-hover:bg-accent/20 transition-colors duration-300">
                      <Icon name={feature.icon} className="text-accent" size={26} />
                    </div>
                    <div className="flex-1">
                      <div className="flex items-center justify-between mb-2">
                        <h4 className="font-bold text-primary text-base leading-tight">{feature.title}</h4>
                        <span className="text-accent font-bold text-sm">{feature.stat}</span>
                      </div>
          ...
          <div className="order-1 lg:order-2">
            <div className="relative group">
              ...
              />
              <div className="absolute -bottom-6 -right-6 bg-white rounded-xl shadow-xl p-6 border-2 border-accent/20">
